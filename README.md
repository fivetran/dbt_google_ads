...
- Produces modeled tables that leverage Google Ads data from [Fivetran's connector](https://fivetran.com/docs/applications/google-ads) in the format described by [this ERD](https://fivetran.com/docs/applications/google-ads#schemainformation).
...
| **Table** | **Details** |
|-----------|-------------|
| [`google_ads__account_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__account_report) | Represents daily performance aggregated at the account level, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• How does performance compare across different accounts I manage?<br>• Are currency fluctuations affecting results across markets? |
| [`google_ads__ad_group_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__ad_group_report) | Represents daily performance at the ad group level, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• Which ad groups have the strongest engagement relative to their budget?<br>• Do certain ad groups dominate impressions within a campaign?<br>• Are new ad groups ramping up as expected after launch? |
| [`google_ads__ad_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__ad_report) | Represents daily performance at the individual ad level, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• Which ad creatives are driving the lowest cost per click?<br>• Do expanded text ads perform better than responsive search ads?<br>• How do performance trends change after refreshing ad copy? |
| [`google_ads__campaign_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__campaign_report) | Represents daily performance aggregated at the campaign level, including `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• Which campaigns are most efficient in terms of cost per conversion?<br>• Are paused or limited-status campaigns still accruing impressions?<br>• How does performance vary by advertising channel type (Search, Display, Video)? |
| [`google_ads__keyword_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__keyword_report) | Represents daily performance at the keyword level, enriched with account, campaign, ad group, and criterion context. Includes metrics such as `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• Which keywords are driving the highest quality traffic at the lowest cost?<br>• Are branded vs. non-branded keywords performing differently?<br>• Should underperforming keywords be reallocated to different match types? |
| [`google_ads__search_term_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__search_term_report) | Represents daily performance at the search term and keyword level, enriched with account, campaign, and ad group context. Includes metrics such as `spend`, `clicks`, `impressions`, and `conversions`.<br><br>**Example Analytics Questions:**<br>• What new queries are emerging that I should add as keywords?<br>• Which irrelevant queries should be added as negatives to reduce wasted spend?<br>• Are there seasonal shifts in search terms driving conversions? |
