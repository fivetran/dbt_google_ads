...
| **Table** | **Details** |
|-----------|-------------|
| [`google_ads__account_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__account_report) | Represents daily performance aggregated at the account level.<br><br>**Example Analytics Questions:**<br>• How is overall account performance trending over time?<br>• Which accounts are delivering the highest ROI? |
| [`google_ads__campaign_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__campaign_report) | Contains daily campaign-level performance by advertising channel and subtype.<br><br>**Example Analytics Questions:**<br>• Which campaigns drive the most conversions or revenue?<br>• How do different channel subtypes (e.g., Search vs. Display) perform? |
| [`google_ads__ad_group_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__ad_group_report) | Represents daily performance at the ad group level within campaigns.<br><br>**Example Analytics Questions:**<br>• Which ad groups are underperforming relative to spend?<br>• How effective are different audience or targeting setups? |
| [`google_ads__keyword_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__keyword_report) | Tracks daily keyword-level performance within ad groups.<br><br>**Example Analytics Questions:**<br>• Which keywords are generating the highest CTR or conversion rate?<br>• Are there low-performing keywords that should be paused? |
| [`google_ads__ad_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__ad_report) | Captures daily performance of individual ads.<br><br>**Example Analytics Questions:**<br>• Which ad creatives deliver the highest CTR or conversions?<br>• Are certain ad formats outperforming others? |
| [`google_ads__url_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__url_report) | Contains daily performance metrics for final URLs at the ad level.<br><br>**Example Analytics Questions:**<br>• Which landing pages are driving the most conversions?<br>• Are certain URLs underperforming despite high traffic? |
| [`google_ads__search_term_report`](https://fivetran.github.io/dbt_google_ads/#!/model/model.google_ads.google_ads__search_term_report) | Shows daily performance of search terms matched to tracked keywords.<br><br>**Example Analytics Questions:**<br>• Which search queries are driving the most qualified traffic?<br>• Are there irrelevant queries that should be added as negative keywords? |
